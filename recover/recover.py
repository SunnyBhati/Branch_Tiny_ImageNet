...
def main_worker(gpu, ngpus_per_node, args, model_teacher, model_verifier, ipc_id_range):
    ...
    counter = 0
    #btach_size=100,total_number=200,sub-btach-size=batch_size//3
    ##turn_index200
...
def main_syn():
    ...
    aux_teacher = ["ResNet18", "ConvNetW128", "MobileNetV2", "WRN_16_2", "ShuffleNetV2_0_5","efficient_b"]
